...
```bash
pnpm add three @react-three/fiber @react-three/timeline
```


### What does it look like?

| A simple timeline with 2 actions (look at red pill and look at blue pill) with an infinite loop | ![render of the above code](./basic-example.gif) |
| --------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------- |
...
- [What is a timeline?](./1-what-is-a-timeline.mdx)
- [Building your First Timeline](./2-first-timeline.mdx)
- [Overview of All Functions](./3-overview.mdx)
- [Tutorial: Building Complex Timelines using Parallel](../tutorials/5-parallel.mdx)
- [Tutorial: Building Graph Timelines](../tutorials/6-graph.mdx)
- [Tutorial: Use pmndrs/timeline in vanilla three.js](../tutorials/7-vanilla.mdx)
